        ...
        "1u9Kb": [
            function(require, module1, exports1) {
                ...
                document.addEventListener("DOMContentLoaded", ()=>{
                    ...
                    const Layout = (0, _react1.getLayout)(_popupTsx);
 ...
 */ "use strict";
        ...
        "1iCQU": [
            function(require, module1, exports1) {
                ...
                var _inputField = require("~components/forms/InputField");
                var _textInputField = require("~components/forms/TextInputField");
                var _checkboxInputField = require("~components/forms/CheckboxInputField");
                var _constants = require("~constants");
                function IndexPopup() {
                    const [error, setError] = (0, _react.useState)();
                    const [storedAddress, setStoredAddress] = (0, _hook.useStorage)((0, _storage.STORAGE_KEY_ADDRESS), "https://gitpod.io");
                    const [address, setAddress] = (0, _react.useState)(storedAddress);
                    const updateAddress = (0, _react.useCallback)((address)=>{
                        setAddress(address);
                        try {
                            const parsed = (0, _parseEndpoint.parseEndpoint)(address);
                    ...
                    const [openInNewTab, setOpenInNewTab] = (0, _hook.useStorage)((0, _storage.STORAGE_KEY_NEW_TAB), false);
                    const [automaticallyDetect, setAutomaticallyDetect] = (0, _hook.useStorage)((0, _storage.STORAGE_AUTOMATICALLY_DETECT_GITPOD), true);
                    return /*#__PURE__*/ (0, _jsxRuntime.jsxs)("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, _jsxRuntime.jsxs)("form", {
                                className: "w-full",
                                children: [
                                    /*#__PURE__*/ (0, _jsxRuntime.jsx)((0, _inputField.InputField), {
                                        label: "Gitpod URL",
                                        hint: `Gitpod instance URL, e.g. ${(0, _constants.DEFAULT_GITPOD_ENDPOINT)}.`,
                                        topMargin: false,
                                        children: /*#__PURE__*/ (0, _jsxRuntime.jsx)("div", {
                                            className: "flex space-x-2",
                                            children: /*#__PURE__*/ (0, _jsxRuntime.jsx)("div", {
                                                className: "flex-grow",
                                                children: /*#__PURE__*/ (0, _jsxRuntime.jsx)((0, _textInputField.TextInput), {
                                                    value: address,
                                    ...
                                    /*#__PURE__*/ (0, _jsxRuntime.jsx)((0, _checkboxInputField.CheckboxInputField), {
            ...
            },
            {
                ...
                "./popup.css": "aOBPF",
                "~components/forms/InputField": "8UWuM",
                "~components/forms/TextInputField": "d6qKm",
                "~components/forms/CheckboxInputField": "92J5E",
                "~constants": "HekoT",
                "@parcel/transformer-js/src/esmodule-helpers.js": "z4dxc"
            }
        ],
 ...
 * * */ var IPv4SegmentFormat = "(?:[0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])";
        ...
        "8UWuM": [
            function(require, module1, exports1) {
                var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
                parcelHelpers.defineInteropFlag(exports1);
                parcelHelpers.export(exports1, "InputField", ()=>InputField);
                var _jsxRuntime = require("react/jsx-runtime");
                var _classnames = require("classnames");
                var _classnamesDefault = parcelHelpers.interopDefault(_classnames);
                var _react = require("react");
                var _reactDefault = parcelHelpers.interopDefault(_react);
                var _inputFieldHint = require("./InputFieldHint");
                const InputField = /*#__PURE__*/ (0, _react.memo)(({ label, id, hint, error, topMargin = true, className, children, disabled = false })=>{
                    return /*#__PURE__*/ (0, _jsxRuntime.jsxs)("div", {
                        className: (0, _classnamesDefault.default)("flex flex-col space-y-2", {
                            "mt-4": topMargin
                        }, className),
                        children: [
                            label && /*#__PURE__*/ (0, _jsxRuntime.jsx)("label", {
                                className: (0, _classnamesDefault.default)("text-sm font-semibold", disabled ? "text-gray-400 dark:text-gray-400" : error ? "text-red-600 dark:text-red-400" : "text-gray-600 dark:text-gray-100"),
                                htmlFor: id,
                                children: label
                            }),
                            children,
                            ...
                            hint && /*#__PURE__*/ (0, _jsxRuntime.jsx)((0, _inputFieldHint.InputFieldHint), {
                                children: hint
                            })
                        ]
                    });
...
*/ /* global define */ (function() {
        ...
        "hQBm3": [
            function(require, module1, exports1) {
                var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
                parcelHelpers.defineInteropFlag(exports1);
                parcelHelpers.export(exports1, "InputFieldHint", ()=>InputFieldHint);
                var _jsxRuntime = require("react/jsx-runtime");
                var _classnames = require("classnames");
                var _classnamesDefault = parcelHelpers.interopDefault(_classnames);
                var _react = require("react");
                var _reactDefault = parcelHelpers.interopDefault(_react);
                const InputFieldHint = ({ disabled = false, children })=>{
                    return /*#__PURE__*/ (0, _jsxRuntime.jsx)("span", {
                        className: (0, _classnamesDefault.default)("text-sm", disabled ? "text-gray-400 dark:text-gray-400" : "text-gray-500 dark:text-gray-400"),
                        children: children
                    });
                };
            },
 ...
 */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
                parcelHelpers.defineInteropFlag(exports1);
                parcelHelpers.export(exports1, "TextInputField", ()=>TextInputField);
                parcelHelpers.export(exports1, "TextInput", ()=>TextInput);
                var _jsxRuntime = require("react/jsx-runtime");
                var _classnames = require("classnames");
                var _classnamesDefault = parcelHelpers.interopDefault(_classnames);
                var _react = require("react");
                ...
                const TextInputField = /*#__PURE__*/ (0, _react.memo)(({ type = "text", label, value, id, placeholder, hint, error, disabled = false, required = false, topMargin, containerClassName, onChange, onBlur })=>{
                    const maybeId = (0, _react.useId)();
                    const elementId = id || maybeId;
                    return /*#__PURE__*/ (0, _jsxRuntime.jsx)((0, _inputField.InputField), {
                        id: elementId,
                        label: label,
                        hint: hint,
                        error: error,
                        ...
                        children: /*#__PURE__*/ (0, _jsxRuntime.jsx)(TextInput, {
                            id: elementId,
                            value: value,
                            type: type,
                ...
                const TextInput = /*#__PURE__*/ (0, _react.memo)(({ type = "text", value, className, id, placeholder, disabled = false, required = false, onChange, onBlur })=>{
                    const handleChange = (0, _react.useCallback)((e)=>{
                        onChange && onChange(e.target.value);
                    }, [
                        onChange
                    ]);
                    const handleBlur = (0, _react.useCallback)(()=>onBlur && onBlur(), [
                        onBlur
                    ]);
                    return /*#__PURE__*/ (0, _jsxRuntime.jsx)("input", {
                        id: id,
                        className: (0, _classnamesDefault.default)("w-full text-base", "block text-gray-600 dark:text-gray-400 dark:bg-gray-800 bg-white rounded-md border border-gray-300 dark:border-gray-500 focus:border-gray-400 dark:focus:border-gray-400 focus:ring-0", "py-2 px-3", "placeholder:text-gray-400 dark:placeholder:text-gray-500", "disabled:bg-gray-100 dark:disabled:bg-gray-700 disabled:border disabled:border-gray-200 dark:disabled:border-gray-600 disabled:text-gray-400 dark:disabled:text-gray-500", className),
                        value: value,
                        type: type,
                        placeholder: placeholder,
                        disabled: disabled,
        ...
        "92J5E": [
            function(require, module1, exports1) {
                var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
                parcelHelpers.defineInteropFlag(exports1);
                parcelHelpers.export(exports1, "CheckboxListField", ()=>CheckboxListField);
                parcelHelpers.export(exports1, "CheckboxInputField", ()=>CheckboxInputField);
                var _jsxRuntime = require("react/jsx-runtime");
                var _classnames = require("classnames");
                var _classnamesDefault = parcelHelpers.interopDefault(_classnames);
                var _react = require("react");
                ...
                var _inputField = require("./InputField");
                var _inputFieldHint = require("./InputFieldHint");
                const CheckboxListField = ({ label, error, className, topMargin, children })=>{
                    return /*#__PURE__*/ (0, _jsxRuntime.jsx)((0, _inputField.InputField), {
                        label: label,
                        className: className,
                        error: error,
                ...
                const CheckboxInputField = ({ id, value, label, hint, error, checked, disabled = false, topMargin = true, containerClassName, onChange })=>{
                    const maybeId = (0, _react.useId)();
                    const elementId = id || maybeId;
                    const handleChange = (0, _react.useCallback)((e)=>{
                    ...
                    return /*#__PURE__*/ (0, _jsxRuntime.jsx)((0, _inputField.InputField), {
                        ...
                        children: /*#__PURE__*/ (0, _jsxRuntime.jsxs)("label", {
                            className: "flex space-x-2 justify-start items-start max-w-lg",
                            htmlFor: elementId,
                            children: [
                                /*#__PURE__*/ (0, _jsxRuntime.jsx)("input", {
                                    type: "checkbox",
                                    className: (0, _classnamesDefault.default)("h-4 w-4 mt-0.5 rounded cursor-pointer border-2 dark:invert", "focus:ring-2 ring-blue-400", "border-gray-600 dark:border-gray-900 bg-transparent", "checked:bg-gray-600 dark:checked:bg-gray-900"),
                                    id: elementId,
                                    checked: checked,
                                    disabled: disabled,
                                    value: value,
                                ...
                                /*#__PURE__*/ (0, _jsxRuntime.jsxs)("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, _jsxRuntime.jsx)("span", {
                                            className: (0, _classnamesDefault.default)("text-sm font-bold cursor-pointer", disabled ? "text-gray-400 dark:text-gray-400" : "text-gray-600 dark:text-gray-100"),
                                            children: label
                                        }),
                                        hint && /*#__PURE__*/ (0, _jsxRuntime.jsx)((0, _inputFieldHint.InputFieldHint), {
                                            disabled: disabled,
        ...
        "1u9Kb"
    ], "1u9Kb", "parcelRequire24b8");
    //# sourceMappingURL=popup.cc3817b7.js.map
